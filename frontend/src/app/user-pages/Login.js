          ...
          <div className="row w-100 mx-0">
            <div className="col-lg-4 mx-auto">
              <div className="card text-left py-5 px-4 px-sm-5">
                ...
                <h4 style={{textAlign: "center"}}>Login to Doppler</h4>
                <Form className="pt-3">
                  ...
                  <div className="mt-3">
                    <Link className="btn btn-block btn-fw btn-function btn-lg font-weight-medium auth-form-btn" to="/dashboard">SIGN IN</Link>
                  </div>
